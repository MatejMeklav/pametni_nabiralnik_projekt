...
<div class="container">
    <div class="card bg-light">
        <article class="card-body mx-auto" style="max-width: 400px;">
            <h4 class="card-title mt-3 text-center">Ustvarite račun</h4>
            <form method="POST" action="?controller=uporabnik&action=registracija">
                ...
                <p class="text-center">Že imate račun? <a href="?controller=uporabnik&action=prijava">Prijava</a> </p>
            </form>
        </article>
    </div> <!-- card.// -->
</div>
